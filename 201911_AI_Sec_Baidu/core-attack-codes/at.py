...
add_arg('input',            str,   "/home/aistudio/work/image_classification/data/ILSVRC2012/",     "Input directory with images")
add_arg('output',           str,   "/home/aistudio/work/image_classification/data/dyngq_ILSVRC2020/",    "Output directory with images")
...
def gen_adv():
    ...
    with open('train_list.txt','w') as f:
        for filename, label in original_files:
            ...
            reslabel = prelabel
            if label == prelabel:
                adv_img, reslabel = attack_nontarget_by_FGSM(img, label)
            else:
            ...
            print(filename,reslabel)
            
            f.writelines(filename+' '+str(reslabel)+'\n')
